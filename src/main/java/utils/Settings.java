...
public class Settings {
    ...
    public static String getDEV_DBConnection(){
        intializeProperties();
        return String.format("jdbc:mysql://%s:%s/%s",props.getProperty("db.server"),props.getProperty("db.port"),props.getProperty("db.database") + "?serverTimezone=CET");
    }
    ...
    public static String getTEST_DBConnection(){
        ...
        return String.format("jdbc:mysql://%s:%s/%s",server,port,props.getProperty("dbtest.database") + "?serverTimezone=CET");
    }
